...
def blog_post_create_view(request):
    ...
    if form.is_valid():
        ...
        idiom(form, name)
        resumo = bert_sumarizar(form)
        ent_list, lang_code, lang_code_short, lang_code_full = entities(form.cleaned_data['content'])
        output_tri, output_bi, filtered_word_1 = cleaner(form.cleaned_data['content'], lang_code_short)
        alt_freq_bai_ord, bai_freq_alt_ord, alt_freq_alt_ord, bai_freq_bai_ord = proto(filtered_word_1)        
